...
"""
source ./scripts/provision.sh PROMICRO
...
# 'bootloader' : 1,
 'binary_name' : 'espruino_%v_promicro.uf2',
 'build' : {
   'optimizeflags' : '-Os',
   'libraries' : [
     'BLUETOOTH',
...
chip = {
  ...
  'dac' : 0,
  'saved_code' : {
    'address' : ((244 - 100) * 4096), # Bootloader takes pages 244-255
    'page_size' : 4096,
    'pages' : 100,
    'flash_available' : 1024 - ((38 + 12 + 2 + 100)*4), # Softdevice uses 0x26=38 pages of flash, bootloader 12, FS 2, code 100. Each page is 4 kb.
  },
};
